...
_G.packer_plugins = {
  ...
  ["moonlight.nvim"] = {
    loaded = true,
    path = "/home/adi/.local/share/nvim/site/pack/packer/start/moonlight.nvim",
  ...
  ["nightfox.nvim"] = {
    loaded = true,
    path = "/home/adi/.local/share/nvim/site/pack/packer/start/nightfox.nvim",
  ...
  onehalf = {
    loaded = true,
    path = "/home/adi/.local/share/nvim/site/pack/packer/start/onehalf",
